...
return [
    ...
    'allowed_origins' => array_values(array_filter(array_map(
        ...
        explode(',', env(
            ...
            'http://localhost:5173,http://localhost:3000,https://ardoise-info.dawzss.com'
        ))
    ))),
    ...
    //     explode(',', env(
    //         'CORS_ALLOWED_ORIGINS',
    //         'http://localhost:5173,http://127.0.0.1:5173,http://localhost:3000,http://100.89.243.114:5173'
    //     ))
    // ))),
