...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('tb_turnos_cajas', function (Blueprint $table) {
            $table->decimal('total_depositos_efectivo', 12, 2)->default(0)->after('total_retiros_efectivo');
        });

        Schema::create('tb_deposito_efectivo_en_turno', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tb_deposito_efectivo_en_turno');

        Schema::table('tb_turnos_cajas', function (Blueprint $table) {
            $table->dropColumn('total_depositos_efectivo');
        });
    }
};
