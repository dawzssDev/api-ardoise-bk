...
class CreateMaeCuentaContaSucRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'tipo_cuenta' => ['required', 'string', Rule::in(MaeCuentaContaSuc::TIPOS)],
            'sucursal_id' => [
            ...
            'titulo_cuenta' => ['required', 'string', 'max:150'],
