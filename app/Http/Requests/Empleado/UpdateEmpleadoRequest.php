...
class UpdateEmpleadoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'fecha_alta_seguro' => ['sometimes', 'nullable', 'date'],
            ...
            'bono_desempeno' => ['sometimes', 'nullable', 'numeric', 'min:0'],
